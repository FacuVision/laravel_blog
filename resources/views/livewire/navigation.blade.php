<nav class="bg-gray-800" x-data = "{open:false}">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        @foreach ($categories as $cat)
                            <a href="#"
                                class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">{{ $cat->name }}</a>
                        @endforeach
    ...
    <div class="sm:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2">
            ...
            @foreach ($categories as $cat)
                <a href="#"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">{{ $cat->name }}</a>
            @endforeach
        </div>
    </div>
</nav>
